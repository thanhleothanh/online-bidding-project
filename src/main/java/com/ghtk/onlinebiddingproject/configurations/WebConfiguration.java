...
public class WebConfiguration implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        registry.addMapping("/**").allowedOriginPatterns("https://auctiontime.netlify.app", "http://localhost:3000", "http://127.0.0.1:3000", "https://onlinebiddingproject.netlify.app", "http://20.172.145.151:80", "http://20.172.145.151:443", "http://20.172.145.151").allowedMethods("GET", "POST", "PUT", "DELETE", "OPTIONS").allowCredentials(true).exposedHeaders("Set-Cookie");
    }
}
